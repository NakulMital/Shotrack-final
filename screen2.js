  ...
  display() {
    ...
    function change() {
      ...
      function change1M() {
        ...
        warn.html("Touch the court twice to begin")
        warn.position(50,700)
        warn.id('warn');
        ...
        courtM.position(width/2-195,height/2+200)
        courtM.id("courtM")
...
courtM.touchStarted(function(){document.getElementById("courtM").addEventListener("touchstart",function(e){
        ...
        miss.position(width / 1.45, height / 4);
...
//button three created
        ...
        button3.position(width/2+50, height/2-150);
        ...
        function change2() {
          ...
          accuracy.position(width / 2 - 97, height / 2 - 200);

          var score = createElement('h1');
          score.html(made + "/" + total)
          score.position(width / 2 - 60, height / 2 - 170);

          var percent = createElement('h2', "P E R C E N T A G E");
          percent.position(width / 2 - 130, height / 2-30);
          ...
          score.position(width / 2 - 70, height / 2 );
        }
      }
